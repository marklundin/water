// Generated from demo/editor/AdriftTerrain.mjs. Keep its companion modules in the same Editor folder.
import { Script, Entity, Asset, StandardMaterial, ADDRESS_REPEAT } from 'playcanvas';
import { applyTerrain, applyRockWaterline } from './adrift-materials.mjs';
