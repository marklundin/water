var oe=Object.defineProperty;var ne=(o,e,r)=>e in o?oe(o,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[e]=r;var w=(o,e,r)=>ne(o,typeof e!="symbol"?e+"":e,r);import{bs as T,bt as ue,bu as ce,I as J,J as q,bv as Y,w as F,aJ as ee,aO as L,aN as _,P as O,x as y,F as R,p as W,W as le,B as me,V as k,b1 as H,C as fe,U as pe,aA as de,aD as he,m as ve,E as ge,bw as xe,k as Se}from"./Sky-kDXoWfl0.js";class we{constructor(){w(this,"value");w(this,"scopeId",null)}}class A{constructor(e,r,t="Unnamed"){w(this,"shader",null);w(this,"name");w(this,"parameters",new Map);w(this,"countX",1);w(this,"countY");w(this,"countZ");w(this,"indirectSlotIndex",-1);w(this,"indirectBuffer",null);w(this,"indirectFrameStamp",0);this.device=e,this.shader=r,this.name=t,e.supportsCompute&&(this.impl=e.createComputeImpl(this))}setParameter(e,r){let t=this.parameters.get(e);t||(t=new we,t.scopeId=this.device.scope.resolve(e),this.parameters.set(e,t)),t.value=r}getParameter(e){var r;return(r=this.parameters.get(e))==null?void 0:r.value}deleteParameter(e){this.parameters.delete(e)}destroy(){var e;(e=this.impl)==null||e.destroy(),this.impl=null}applyParameters(){for(const[,e]of this.parameters)e.scopeId.setValue(e.value)}setupDispatch(e,r,t){this.countX=e,this.countY=r,this.countZ=t,this.indirectSlotIndex=-1,this.indirectBuffer=null}setupIndirectDispatch(e,r=null){this.indirectSlotIndex=e,this.indirectBuffer=r,this.indirectFrameStamp=this.device.renderVersion}static calcDispatchSize(e,r,t=65535){if(e<=t)return r.set(e,1);const s=Math.ceil(e/t);return r.set(Math.ceil(e/s),s)}}const te=`
...
`,ye=te.replace(/uniform sampler2D uCaustWave[01];\n/g,"").replace(/uCaustWave([01])/g,(o,e)=>`uDeriv${Number(e)+2}`),be=ae.replace(/var uCaustWave[01](?:Sampler)?: [^;]+;\n/g,"").replace(/uCaustWave([01])/g,(o,e)=>`uDeriv${Number(e)+2}`),V=new WeakSet;function Z(o,e,r){const t=[];for(let s=0;s<2;s++){const i=Math.max(0,e.lengthScales.length-2+s);o.setParameter(`uCaustWave${s}`,e.derivativeTextures[i]),t.push(1/e.lengthScales[i])}o.setParameter("uCaustWaveScales",t),o.setParameter("uCaustWaveSettings",[r.waves.amplitude,r.waves.choppiness,e.params.size])}const _e=`
